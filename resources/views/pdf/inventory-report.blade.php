        ...
        <tr>
            ...
            <td>
                ...
                @if($product->status == 'Tersedia')
                    <span class="status-tersedia">Available</span>

                @elseif($product->status == 'Dipinjam')
                    <span class="status-dipinjam">Borrowed</span>

                @else
                    <span class="status-rusak">{{ $product->status }}</span>
...
<div class="footer">
    ...
    This report was automatically generated by Nexventory.
